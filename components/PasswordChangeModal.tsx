...
const PasswordChangeModal = ({ modal }: PasswordChangeModalProps) => {
	...
	return (
			<div className="fixed inset-0 z-50 flex items-center justify-center" onClick={modal.close}>
				<div className="absolute inset-0 bg-black bg-opacity-50" />
				<div
						className="relative z-10 w-[90vw] max-w-md bg-white rounded-xl shadow-2xl p-6"
